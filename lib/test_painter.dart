...
class TextRecognizerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final textBlock in recognizedText.blocks) {
      ...
      // final left = textBlock.boundingBox.left;
      // final top = textBlock.boundingBox.top;
      // final right = textBlock.boundingBox.right;
      // final bottom = textBlock.boundingBox.bottom;
